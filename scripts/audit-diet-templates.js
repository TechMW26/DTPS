...
// Extra aliases — covers ALL known variations found in DB
...
LABEL_TO_KEY['past dinner'] = 'PAST_DINNER';   // ← "Past Dinner" found in DB
LABEL_TO_KEY['pastdinner'] = 'PAST_DINNER';
...
// Ramadan-specific meal types → map to closest canonical type
LABEL_TO_KEY['sehri'] = 'EARLY_MORNING';       // pre-dawn Ramadan meal
LABEL_TO_KEY['suhoor'] = 'EARLY_MORNING';
LABEL_TO_KEY['ifthari'] = 'EVENING';            // breaking fast (Iftar)
LABEL_TO_KEY['iftar'] = 'EVENING';
LABEL_TO_KEY['iftaar'] = 'EVENING';
// Workout-related
LABEL_TO_KEY['post workout'] = 'MID_EVENING';   // post workout snack
LABEL_TO_KEY['post-workout'] = 'MID_EVENING';
LABEL_TO_KEY['pre workout'] = 'MID_MORNING';
LABEL_TO_KEY['pre-workout'] = 'MID_MORNING';
// Detox-specific
LABEL_TO_KEY['detox water'] = 'EARLY_MORNING';  // detox water → early morning
// Hyphenated / typo variations found in DB
LABEL_TO_KEY['mid-morning'] = 'MID_MORNING';    // "Mid-Morning" (hyphenated)
LABEL_TO_KEY['mid-evening'] = 'MID_EVENING';
LABEL_TO_KEY['break fast'] = 'BREAKFAST';        // typo with space
LABEL_TO_KEY['bedtime'] = 'PAST_DINNER';         // bedtime → post dinner
